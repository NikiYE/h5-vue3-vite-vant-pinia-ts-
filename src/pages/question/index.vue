<template>
  ...
  <svg id="visual" width="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
    version="1.1">
    <path
  ...
  <div class="footer">
    ...
    <svg id="visual" viewBox="0 0 900 675" width="100%" xmlns="http://www.w3.org/2000/svg"
...
const transformData = (data: AnswerForm) => {
  ...
  for (const key in data) {
    if (data.hasOwnProperty(key) && !['prize', 'otherGroup', 'graduationTime', 'enrollmentTime'].includes(key)) {
      ...
      transformed.answers.push(questionEntry);
    }
  }
  // 特殊处理奖项
